...
angular.module('ngConstellation', ['ng'])
    ...
    .factory('constellationManagement', ['$http', function ($http) {
        var constellationProxy = {
            ...
            getRequestUri: function (method) {
                return constellationProxy.urlBase + method + "?t=" + new Date().getTime();
            },
            ...
            getPackageIconUri: function (packageName) {
                ...
                return constellationProxy.getRequestUri("GetPackageIcon") + "&" + encodeQueryParameter({
                    package: packageName,
